<template>
  <div>
    ...
    <el-card>
      ...
      <!-- Tab栏区域 -->
      <template>
        <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-position="top" label-width="100%">
          <el-tabs tab-position="left" v-model="activeIndex" :before-leave="beforeLeave" @tab-click="tabClicked">
            ...
            <el-tab-pane label="基本信息" name="0">
              ...
              <el-form-item label="商品分类" prop="goods_cat">
                <el-cascader :props="cateProps" v-model="addForm.goods_cat" @change="handleChange" :options="catelist">
                </el-cascader>
              </el-form-item>
            </el-tab-pane>
